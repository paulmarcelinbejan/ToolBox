...
mkdir -p $GENERATED_FOLDER/$ENTITY_LOWERCASE/$SERVICE_FOLDER
mkdir -p $GENERATED_FOLDER/$ENTITY_LOWERCASE/$SERVICE_FOLDER/$IMPL_FOLDER
mkdir -p $GENERATED_FOLDER/$ENTITY_LOWERCASE/$MAPPER_FOLDER
mkdir -p $GENERATED_FOLDER/$ENTITY_LOWERCASE/$REPOSITORY_FOLDER

# Output files
CONTROLLER_OUTPUT="${SCRIPT_DIRECTORY}/${GENERATED_FOLDER}/$ENTITY_LOWERCASE/${CONTROLLER_FOLDER}/${ENTITY}RestController.java"
SERVICE_OUTPUT="${SCRIPT_DIRECTORY}/${GENERATED_FOLDER}/$ENTITY_LOWERCASE/${SERVICE_FOLDER}/${ENTITY}Service.java"
SERVICEIMPL_OUTPUT="${SCRIPT_DIRECTORY}/${GENERATED_FOLDER}/$ENTITY_LOWERCASE/${SERVICE_FOLDER}/${IMPL_FOLDER}/${ENTITY}ServiceImpl.java"
MAPPER_OUTPUT="${SCRIPT_DIRECTORY}/${GENERATED_FOLDER}/$ENTITY_LOWERCASE/${MAPPER_FOLDER}/${ENTITY}Mapper.java"
REPOSITORY_OUTPUT="${SCRIPT_DIRECTORY}/${GENERATED_FOLDER}/$ENTITY_LOWERCASE/${REPOSITORY_FOLDER}/${ENTITY}Repository.java"
